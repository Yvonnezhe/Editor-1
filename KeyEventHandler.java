...
//            int charWidth1 = (int) Math.round(removetemp.getItem().getLayoutBounds().getWidth());
//            editor.curLength -= charWidth1;
        ...
        while (removetemp != null) {
            ...
            editor.positionX = (editor.curLength) % lineLength;
            editor.positionY = charHeight * ((editor.curLength) / lineLength) + 100;
...
//                    temp.updateYPos(editor.positionY);
                    displayText.setX(temp.getXPos());
                    displayText.setY(temp.getYPos());
                    temp.updateXPos(editor.positionX);
                    temp.updateYPos(editor.positionY);
                ...
                editor.textLength -= charWidthDelete;
